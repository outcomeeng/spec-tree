...
Right: spx/NN-infra.enabler/NN-parser.enabler

Wrong: 15-build.adr.md
Right: spx/NN-spec-tree.enabler/NN-build.adr.md
```
...
Always use full paths when referencing nodes. `32-parser.enabler` is ambiguous; `spx/NN-infra.enabler/NN-parser.enabler` is not.
